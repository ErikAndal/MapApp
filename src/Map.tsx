...
type MyComponentProps = {
  handleStateClick: (title: string) => void;
  nextState: string | null;
};

const Map: React.FC<MyComponentProps> = ({ handleStateClick, nextState }) => {
  const [activeStates, setActiveStates] = useState(new Set());
  const [lastWrongState, setLastWrongState] = useState("");

  const handleMapClick = (event: React.MouseEvent<SVGElement, MouseEvent>) => {
    const path = (event.target as SVGElement).closest("path");
    const title = path?.dataset.title;
    if (path && title) {
      handleStateClick(title);
      if (title == nextState) {
        if (activeStates.size < 50) {
        ...
        setLastWrongState(title);
        setTimeout(() => setLastWrongState(""), 1000);
      }
    } else {
      console.log("Clicked outside any path");
    }
  };
    ...
    <div className="map">
      ...
      >
        ...
        <g className="state">
          <path
            className={
              activeStates.has("Alabama")
                ? "active"
                : lastWrongState === "Alabama"
                ? "wrong"
                : ""
            }
            data-title="Alabama"
          ...
          <path
            className={
              activeStates.has("Alaska")
                ? "active"
                : lastWrongState === "Alaska"
                ? "wrong"
                : ""
            }
            data-title="Alaska"
          ...
          <path
            className={
              activeStates.has("Arizona")
                ? "active"
                : lastWrongState === "Arizona"
                ? "wrong"
                : ""
            }
            data-title="Arizona"
          ...
          <path
            className={
              activeStates.has("Arkansas")
                ? "active"
                : lastWrongState === "Arkansas"
                ? "wrong"
                : ""
            }
            data-title="Arkansas"
          ...
          <path
            className={
              activeStates.has("California")
                ? "active"
                : lastWrongState === "California"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Colorado")
                ? "active"
                : lastWrongState === "Colorado"
                ? "wrong"
                : ""
            }
            data-title="Colorado"
          ...
          <path
            className={
              activeStates.has("Connecticut")
                ? "active"
                : lastWrongState === "Connecticut"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Delaware")
                ? "active"
                : lastWrongState === "Delaware"
                ? "wrong"
                : ""
            }
            data-title="Delaware"
          ...
          <path
            className={
              activeStates.has("Florida")
                ? "active"
                : lastWrongState === "Florida"
                ? "wrong"
                : ""
            }
            data-title="Florida"
          ...
          <path
            className={
              activeStates.has("Georgia")
                ? "active"
                : lastWrongState === "Georgia"
                ? "wrong"
                : ""
            }
            data-title="Georgia"
          ...
          <path
            className={
              activeStates.has("Hawaii")
                ? "active"
                : lastWrongState === "Hawaii"
                ? "wrong"
                : ""
            }
            data-title="Hawaii"
          ...
          <path
            className={
              activeStates.has("Idaho")
                ? "active"
                : lastWrongState === "Idaho"
                ? "wrong"
                : ""
            }
            data-title="Idaho"
          ...
          <path
            className={
              activeStates.has("Illinois")
                ? "active"
                : lastWrongState === "Illinois"
                ? "wrong"
                : ""
            }
            data-title="Illinois"
          ...
          <path
            className={
              activeStates.has("Indiana")
                ? "active"
                : lastWrongState === "Indiana"
                ? "wrong"
                : ""
            }
            data-title="Indiana"
          ...
          <path
            className={
              activeStates.has("Kansas")
                ? "active"
                : lastWrongState === "Kansas"
                ? "wrong"
                : ""
            }
            data-title="Kansas"
          ...
          <path
            className={
              activeStates.has("Kentucky")
                ? "active"
                : lastWrongState === "Kentucky"
                ? "wrong"
                : ""
            }
            data-title="Kentucky"
          ...
          <path
            className={
              activeStates.has("Louisiana")
                ? "active"
                : lastWrongState === "Louisiana"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Maine")
                ? "active"
                : lastWrongState === "Maine"
                ? "wrong"
                : ""
            }
            data-title="Maine"
          ...
          <path
            className={
              activeStates.has("Maryland")
                ? "active"
                : lastWrongState === "Maryland"
                ? "wrong"
                : ""
            }
            data-title="Maryland"
          ...
          <path
            className={
              activeStates.has("Massachusetts")
                ? "active"
                : lastWrongState === "Massachusetts"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Michigan")
                ? "active"
                : lastWrongState === "Michigan"
                ? "wrong"
                : ""
            }
            data-title="Michigan"
          ...
          <path
            className={
              activeStates.has("Minnesota")
                ? "active"
                : lastWrongState === "Minnesota"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Mississippi")
                ? "active"
                : lastWrongState === "Mississippi"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Missouri")
                ? "active"
                : lastWrongState === "Missouri"
                ? "wrong"
                : ""
            }
            data-title="Missouri"
          ...
          <path
            className={
              activeStates.has("Montana")
                ? "active"
                : lastWrongState === "Montana"
                ? "wrong"
                : ""
            }
            data-title="Montana"
          ...
          <path
            className={
              activeStates.has("Nebraska")
                ? "active"
                : lastWrongState === "Nebraska"
                ? "wrong"
                : ""
            }
            data-title="Nebraska"
          ...
          <path
            className={
              activeStates.has("Nevada")
                ? "active"
                : lastWrongState === "Nevada"
                ? "wrong"
                : ""
            }
            data-title="Nevada"
          ...
          <path
            className={
              activeStates.has("New Hampshire")
                ? "active"
                : lastWrongState === "New Hampshire"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("New Jersey")
                ? "active"
                : lastWrongState === "New Jersey"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("New Mexico")
                ? "active"
                : lastWrongState === "New Mexico"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("New York")
                ? "active"
                : lastWrongState === "New York"
                ? "wrong"
                : ""
            }
            data-title="New York"
          ...
          <path
            className={
              activeStates.has("North Carolina")
                ? "active"
                : lastWrongState === "North Carolina"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("North Dakota")
                ? "active"
                : lastWrongState === "North Dakota"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Oklahoma")
                ? "active"
                : lastWrongState === "Oklahoma"
                ? "wrong"
                : ""
            }
            data-title="Oklahoma"
          ...
          <path
            className={
              activeStates.has("Oregon")
                ? "active"
                : lastWrongState === "Oregon"
                ? "wrong"
                : ""
            }
            data-title="Oregon"
          ...
          <path
            className={
              activeStates.has("Pennsylvania")
                ? "active"
                : lastWrongState === "Pennsylvania"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Rhode Island")
                ? "active"
                : lastWrongState === "Rhode Island"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("South Carolina")
                ? "active"
                : lastWrongState === "South Carolina"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("South Dakota")
                ? "active"
                : lastWrongState === "South Dakota"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Tennessee")
                ? "active"
                : lastWrongState === "Tennessee"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Texas")
                ? "active"
                : lastWrongState === "Texas"
                ? "wrong"
                : ""
            }
            data-title="Texas"
          ...
          <path
            className={
              activeStates.has("Vermont")
                ? "active"
                : lastWrongState === "Vermont"
                ? "wrong"
                : ""
            }
            data-title="Vermont"
          ...
          <path
            className={
              activeStates.has("Virginia")
                ? "active"
                : lastWrongState === "Virginia"
                ? "wrong"
                : ""
            }
            data-title="Virginia"
          ...
          <path
            className={
              activeStates.has("Washington")
                ? "active"
                : lastWrongState === "Washington"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("West Virginia")
                ? "active"
                : lastWrongState === "West Virginia"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Wisconsin")
                ? "active"
                : lastWrongState === "Wisconsin"
                ? "wrong"
                : ""
            }
          ...
          <path
            className={
              activeStates.has("Wyoming")
                ? "active"
                : lastWrongState === "Wyoming"
                ? "wrong"
                : ""
            }
            data-title="Wyoming"
